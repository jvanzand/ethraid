...
def main():
    ...
    parser.add_argument('-gdd', '--gammaddot', 
                        type=float, 
                        required=False, 
                        default=0, 
                        nargs='?', 
    ...
    parser.add_argument('-gdde', '--gammaddot_err', 
                        type=float, 
                        required=False, 
                        default=1e8, 
                        nargs='?', 
    ...
    parser.add_argument('-rvb', '--rv_baseline', 
                        type=float, 
                        required=True,
                        help='Length of RV time baseline in days')
    parser.add_argument('-rvep', '--rv_epoch', 
                        type=float,  
                        required=True,
    ...
    parser.add_argument('-dmu', '--delta_mu', 
                        type=float,  
                        required=False, 
                        nargs='?',
                        help='Change in astrometric proper motion in milliarcseconds/yr')
    parser.add_argument('-dmue', '--delta_mu_err', 
                        type=float,  
                        required=False, 
                        nargs='?',
                        help='Error on dmu')
    ...
    # default=None and const=None by default, no need to set
    parser.add_argument('-vmag', '--vmag', 
                        type=float, 
                        required=False, 
                        nargs='?',
                        help='Apparent V-band magnitude of host star')
    parser.add_argument('-imwav', '--imag_wavelength', 
                        type=float,  
                        required=False, 
                        nargs='?',
                        help='Wavelength of imaging observations (μm)')
    parser.add_argument('-cs', '--contrast_str', 
                        type=str,  
                        required=False, 
                        nargs='?',
    ...
    parser.add_argument('-gn', '--grid_num', 
                        type=int,  
                        required=False, 
                        default=100,
    ...
    parser.add_argument('-rfp', '--read_file_path', 
                        type=str,  
                        required=False,
